...
export default function ImageUpload({ name }: { name: string }) {
  ...
  const MAX_FILE_SIZE = 10 * 1024; // 10MB 제한
  ...
  return (
    <div>
      <div
        className={`border-2 border-dashed border-gray-300 rounded flex items-center justify-center w-96 h-52 cursor-pointer bg-gray-50 ${
